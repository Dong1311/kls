                ...
                <div className="flex-grow-1">
                  ...
                  <div className="content">
                    <Routes>
                      ...
                      <Route
                        path="ke-hoach-thu-thap-da-trinh-duyet/:id"
                        element={<ChiTietKeHoachThuThapDaTrinhDuyet />}
                      />
                      ...
                      <Route
                        path="/ho-so-da-trinh-duyet/:hoSoId/tai-lieu/:taiLieuId"
                        element={<ChiTietTaiLieuDaTrinhDuyet />}
                      />
                      ...
                      <Route
                        path="/ho-so-da-trinh-nlls/:hoSoId/tai-lieu/:taiLieuId"
                        element={<ChiTietTaiLieuDaTrinhNLLS />}
                      />
                      ...
                      <Route
                        path="/ho-so-tu-choi-nlls/:hoSoId/tai-lieu/:taiLieuId"
                        element={<ChiTietTaiLieuTuChoiNLLS />}
                      />

                      <Route
                        path="/quan-ly-danh-sach-ho-so-da-trinh-nlls"
                        element={<QuanLyDanhSachHoSoDaTrinhNLLS />}
                      />
                      <Route
                        path="/quan-ly-chi-tiet-ho-so-da-trinh-nlls/:id"
                        element={<QuanLyChiTietHoSoDaTrinhNLLS />}
                      />
                      <Route
                        path="/quan-ly-chi-tiet-ho-so-da-trinh-nlls/:hoSoId/tai-lieu/:taiLieuId"
                        element={<QuanLyChiTietTaiLieuDaTrinhNLLS />}
                      />
                      ...
                      <Route
                        path="/ho-so-da-nhan-nlls/:hoSoId/tai-lieu/:taiLieuId"
                        element={<ChiTietTaiLieuDaNhanNLLS />}
                      />
                      ...
                      <Route
                        path="/danh-sach-bien-ban-ban-giao-da-gui-duyet"
                        element={<DanhSachBienBanBanGiaoDaGuiDuyet />}
                      />
                      ...
                      <Route
                        path="/danh-sach-ho-so-da-trinh-duyet-luu-kho"
                        element={<DanhSachHoSoDaTrinhDuyetLuuKho />}
                      />
                      ...
                      <Route
                        path="/chi-tiet-tai-lieu-thuoc-kho-du-lieu/:taiLieuId"
                        element={<ChiTietTaiLieuThuocKhoDuLieu />}
                      />
