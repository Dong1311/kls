...
const HienTrangSoHoaKhoDuLieu = () => {
  ...
  const chartData = {
    labels: [`Hồ sơ đã số hóa (${data.soHoSoDaSoHoa})`, `Hồ sơ chưa số hóa (${data.soHoSoChuaSoHoa})`],
    datasets: [
      {
            ...
            >
              ...
              >
                <ul style={{ listStyle: 'none', padding: '0', margin: '0' }}>
                  ...
                  <StatisticItem label="Tổng số tài liệu:" value={data.tongSoTaiLieu} />
                  <StatisticItem label="Số hồ sơ đã số hóa:" value={data.soHoSoDaSoHoa} />
                  <StatisticItem label="Số hồ sơ chưa số hóa:" value={data.soHoSoChuaSoHoa} />
                  <StatisticItem label="Tổng số trang:" value={data.tongSoTrang} />
                </ul>
              </div>
            </div>
          </div>
