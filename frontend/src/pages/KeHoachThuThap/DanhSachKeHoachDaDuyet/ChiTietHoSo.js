    ...
    <div className="container mt-4">
      ...
      <div className="row g-3 mb-4">
        ...
        <SelectInput
          ...
          onChange={handleInputChange}
          options={['Bình thường', 'Bị hư hỏng', 'Bị mốc nhẹ']}
          disabled={hoSo.trangThai !== 'Tạo mới'}
        />
        ...
        <SelectInput
          ...
          onChange={handleInputChange}
          options={['1 năm', '2 năm', '5 năm', '10 năm', '20 năm', '50 năm', 'Vĩnh viễn']}
          disabled={hoSo.trangThai !== 'Tạo mới'}
        />
        <InputField
          label="Từ khóa"
            ...
            {taiLieuList.length > 0 ? (
              taiLieuList.map((taiLieu, index) => (
                <tr key={taiLieu.id}>
                  <td>{index + 1}</td>
                  <td>
                    <Link to={`/tai-lieu/${taiLieu.id}`}>{taiLieu.maDinhDanhVanBan}</Link>
                  </td>
                  <td>
