  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row g-3 mb-4">
        ...
        <InputField label="Mã hồ sơ" name="maHoSo" value={hoSo.maHoSo} onChange={handleInputChange} disabled={hoSo.trangThai !== 'Tạo mới'} />
        <InputField label="Ký hiệu thông tin" name="kyHieuThongTin" value={hoSo.kyHieuThongTin} onChange={handleInputChange} disabled={hoSo.trangThai !== 'Tạo mới'} />
        <InputField label="Mã định danh cơ quan" name="maDinhDanhCoQuan" value={hoSo.maDinhDanhCoQuan} onChange={handleInputChange} disabled={hoSo.trangThai !== 'Tạo mới'} />
        <InputField label="Người tạo" name="nguoiTao" value={hoSo.nguoiTao} disabled />
        <InputField label="Mục lục số/năm HS" name="mucLucSoNamHS" value={hoSo.mucLucSoNamHS} onChange={handleInputChange} disabled={hoSo.trangThai !== 'Tạo mới'} />
        <InputField label="Ngày tạo" name="ngayTao" type="date" value={hoSo.ngayTao ? new Date(hoSo.ngayTao).toISOString().split('T')[0] : ''} onChange={handleInputChange} disabled={hoSo.trangThai !== 'Tạo mới'} />
        <InputField label="Số và ký hiệu hồ sơ" name="soVaKyHieuHoSo" value={hoSo.soVaKyHieuHoSo} onChange={handleInputChange} disabled={hoSo.trangThai !== 'Tạo mới'} />
