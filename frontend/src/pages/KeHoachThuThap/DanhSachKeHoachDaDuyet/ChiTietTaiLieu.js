  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row g-3">
        ...
        <TextInput
          onChange={handleChange}
          label="STT trong hồ sơ"
          name="sttTrongHoSo"
          value={taiLieu.sttTrongHoSo}
          disabled={!isEditable}
        />
        <TextInput
          onChange={handleChange}
        ...
        <SelectInput
          ...
          options={['Bị mốc nhẹ', 'Bình thường', 'Bị hư hỏng']}
          disabled={!isEditable}
        />
        <SelectInput
          onChange={handleChange}
