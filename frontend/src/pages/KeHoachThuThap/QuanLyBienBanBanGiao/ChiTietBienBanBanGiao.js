...
const ChiTietBienBanBanGiao = () => {
  ...
  useEffect(() => {
    fetch('/api/phong-ban')
      .then((response) => response.json())
      .then(setDonViOptions)
    fetch('/api/users')
      .then((response) => response.json())
      .then(setUserOptions)
    fetch('/api/lap-ke-hoach-thu-thap')
      .then((response) => response.json())
      .then(setKeHoachOptions)
  }, [])
    ...
    <div className="container mt-4">
      ...
      <div className="row g-3">
        ...
        <TextInput
          ...
          name="ngayLap"
          type="date"
          value={formatDate(bienBan.ngayLap)}
          onChange={handleChange}
          disabled
        />
      ...
      <div className="d-flex justify-content-end mt-4">
        <button
          ...
          onClick={() => handleSubmit('Đã gửi duyệt')}
