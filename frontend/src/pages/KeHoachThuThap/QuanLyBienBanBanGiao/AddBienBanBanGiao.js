  ...
  return (
    <div className="container mt-4">
          ...
          <tbody>
            {selectedHoSoList.map((hoSo, index) => (
              <tr key={index}>
                <td>{index + 1}</td>
                <td>
                  <select value={hoSo.id} onChange={(e) => handleHoSoChange(e, index)} className="form-control">
      ...
      <div className="d-flex justify-content-end mt-4">
        ...
        <button className="btn btn-primary mx-2" onClick={() => handleSubmit('Tạo mới')} style={{ minWidth: '100px' }}>
          Lưu
        </button>
