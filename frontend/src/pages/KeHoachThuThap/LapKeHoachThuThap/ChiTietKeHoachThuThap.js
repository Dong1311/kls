...
const ChiTietKeHoachThuThap = () => {
  ...
  const handleUpdateKeHoach = (status) => {
    if (
      !keHoachDetail.soKeHoach ||
      !keHoachDetail.tieuDe ||
      !keHoachDetail.ngayBatDau ||
      !keHoachDetail.ngayKetThuc ||
      !keHoachDetail.noiDung
    ) {
    ...
    <div className="container mt-4">
      ...
      <div className="row g-3 mb-4">
        ...
        <InputFieldDate
          ...
          label="Từ ngày"
          name="ngayBatDau"
          value={formatDate(keHoachDetail.ngayBatDau)}
          disabled={keHoachDetail.trangThai !== 'Tạo mới'}
        />
        ...
        <InputFieldDate
          ...
          label="Đến ngày"
          name="ngayKetThuc"
          value={formatDate(keHoachDetail.ngayKetThuc)}
          disabled={keHoachDetail.trangThai !== 'Tạo mới'}
        />
        ...
        <InputField
          ...
          label="Người tạo"
          name="nguoiTao"
          value={keHoachDetail.nguoiTao || 'N/A'}
          disabled={keHoachDetail.trangThai !== 'Tạo mới'}
        />
        ...
        <InputFieldDate
          ...
          label="Ngày tạo"
          name="ngayTao"
          value={formatDate(keHoachDetail.ngayTao)}
          disabled={keHoachDetail.trangThai !== 'Tạo mới'}
        />
